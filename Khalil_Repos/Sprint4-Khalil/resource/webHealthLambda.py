import datetime, urllib3,boto3,os            # datetime: use for Date and time in latency funtion, urllib3: use for PoolManager() 
...
def lambda_handler(event,context):     
    ...
    for value in URLsList:
        gb.URL_TO_MONITOR.append(value)
    ...
    print(URLsList)
    return "Successfully publish the metrics"   # return all webs , availability and latency
